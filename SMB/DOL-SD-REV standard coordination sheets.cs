...
namespace SMB
{
    public partial class DOL : Form
    {
        static public bool exist = false;
        static public DOL obj;
        public string DOLM1;
        public string DOLM2;
        public int count = 0;
        ...
        {//required to define location for database here 
            ...
            CB_1.DataSource = a.GetData(null, "DOL", CB_1.Tag.ToString());
        ...
        private void CB_1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (!Locker)
            {
                ...
                else
                {
                    ...
                    double pp;
                    x = aa.GetData(aa.Dic_in, "DOL", CB_2.Tag.ToString());//data source accept list
                    ...
                    x[0] = "";                   
                    CB_2.DataSource = x;//data source accept list
        ...
        private void CB_2_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (!Locker)
            {
                if (CB_2.Text == "")
                ...
                else
                {
                    ...
                    CB_3.DataSource = aa.GetData(aa.Dic_in, "DOL", CB_3.Tag.ToString());//data source accept list
                }
            }
        }
        private void CB_3_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (!Locker)
            {
                ...
                else
                {
                    ...
                    CB_4.DataSource = aa.GetData(aa.Dic_in, "DOL", CB_4.Tag.ToString());//data source accept list
                }
            }
        ...
        private void CB_4_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (!Locker)
            {
                ...
                else
                {
                    ...
                    CB_5.DataSource = aa.GetData(aa.Dic_in, "DOL", CB_5.Tag.ToString());//data source accept list
                }
            }
        ...
        private void CB_5_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (!Locker)
            {
                ...
                else
                {
                    ...
                    List<double> q = new List<double>();
                    double pp;
                    x = aa.GetData(aa.Dic_in, "DOL", CB_6.Tag.ToString());
                    q = x.Select(n => !double.TryParse(n, out pp) ? double.NaN : Convert.ToDouble(n)).ToList();
                    q.Sort();
                    x = q.Select(c => c == double.NaN || c.ToString() == "NaN" ? "" : Convert.ToString(c)).ToList();
                    x[0] = "";
                    CB_6.DataSource = x;//data source accept list
        ...
        { List<string> temp_l = new List<string>();
            if (!Locker)
            {
                ...
                if (CB_6.SelectedIndex > 0 && CB_6.Text !="")

                {
                    TB_1.Text = aa.GetData(aa.Dic_in, "DOL", TB_1.Tag.ToString())[1];
                    TB_3.Text = aa.GetData(aa.Dic_in, "DOL", TB_3.Tag.ToString())[1];
        ...
        private void CB_2_DropDown(object sender, EventArgs e)
        {
            if (CB_2.DataSource == null && CB_1.Text != "")
            {
                ...
                CB_2.DataSource = aa.GetData(aa.Dic_in, "DOL", CB_2.Tag.ToString());//data source accept list
            }
        }
        ...
        private void CB_6_DropDown(object sender, EventArgs e)
        {
            if (CB_6.DataSource == null && CB_1.Text != "" && CB_2.Text != "" && CB_3.Text != "" && CB_4.Text != "" && CB_5.Text != "")
            {
                AccessDBC aa = new AccessDBC();
                aa.Dic_in.Add(CB_1.Tag.ToString(), CB_1.Text);
                aa.Dic_in.Add(CB_2.Tag.ToString(), CB_2.Text);
                ...
                aa.Dic_in.Add(CB_4.Tag.ToString(), CB_4.Text);
                aa.Dic_in.Add(CB_5.Tag.ToString(), CB_5.Text);
                CB_6.DataSource = aa.GetData(aa.Dic_in, "DOL", CB_6 .Tag.ToString());//data source accept list
            }
        }
        ...
        {
            MessageBox.Show("Schneider BK7 DOL length estimator.\nDesigned by Schneider Egypt.", "About App");
        }
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            //if (AccessDBC.Save_required)
            //{
            //    DialogResult dialogResult = MessageBox.Show("Your unsaved data could be lost. Do you want to save first.", "DOL Metering", MessageBoxButtons.YesNo);
            //    if (dialogResult == DialogResult.Yes)
            //    {
            //        Save_DGV();
            //    }
        ...
        private void linkLabel1_LinkClicked_1(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            tablex = a.Read_DataSet(null, "DOL", "*");
            c.ExportToExcel(tablex, "Dol_SD_REV");
        }

        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Help aa = new Help(Properties.Settings.Default.DOLHelp2, "Standard Coordination Concept");
            aa.ShowDialog();
        }

        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Help aa = new Help(Properties.Settings.Default.DOLHelp1, "Reference & Description Legend");
            aa.ShowDialog();
        }
    }
}
