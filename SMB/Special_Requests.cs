...
namespace SMB
{
    public partial class Special_Requests : Form
    {
        static public bool exist = false;
        static public Special_Requests obj;
        public Special_Requests()
        {
            InitializeComponent();
        }

        private void MotorStarters_Load(object sender, EventArgs e)
        {
            AccessDB aa = new AccessDB();
            List<string> colomn_name;
            colomn_name = aa.GetTableColumnNames(table.Text);
            //MessageBox.Show(table.Text);
        ...
        private void MotorStarters_FormClosing(object sender, FormClosingEventArgs e)
        {
            Special_Requests.exist = false;
        }
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            c.ExportToExcel(tablex, "Special_Requests");
        }
        ...
        private void MotorStarters_KeyDown(object sender, KeyEventArgs e)
        {
