...
namespace SMB
{
    public partial class V_SpeedDrives : Form
    {
        static public bool exist = false;
        static public V_SpeedDrives obj;
        public V_SpeedDrives()
        {
            InitializeComponent();
        }

        private void V_SpeedDrives_Load(object sender, EventArgs e)
        {
        ...
        private void Des5_SelectedIndexChanged(object sender, EventArgs e)
        {
...

            {
                ...
                Des6.Text = aa.GetData(aa.Dic_in, table.Text, Des6.Tag.ToString())[1];//data source accept list
            }
            else
            {
                Ref2.Text = "";
        ...
        private void V_SpeedDrives_FormClosed(object sender, FormClosedEventArgs e)
        {

            V_SpeedDrives.exist = false;
        }
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            List<string> list = new List<string>() { Des1.Tag.ToString(), Des2.Tag.ToString(), Des3.Tag.ToString(), Ref2.Tag.ToString() };
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            tablex = a.Read_DataSet(null, table.Text, list);
            c.ExportToExcel(tablex, "Trip Unit Type");
        }
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            tablex = a.Read_DataSet(null, table.Text, list);
            c.ExportToExcel(tablex, "Contactor");
        }
        ...
        private void V_SpeedDrives_KeyDown(object sender, KeyEventArgs e)
        {
